    ...
    <header class="sticky top-0 bg-white shadow">
        <div class="container flex flex-col sm:flex-row justify-between items-center mx-auto py-4 px-8">
            ...
            <div class="flex mt-4 sm:mt-0">
                ...
                <a class="px-4" href="MakeTransactions.jsp">Manage transactions</a>
        ...
        <button type="submit" class="py-3 px-8 text-sm bg-teal-500 hover:bg-teal-600 rounded text-white">
            Logout
        </button>
    </form>
            </div>
            ...
            <div class="container mx-auto px-8 lg:flex">
                <div class="text-center lg:text-left lg:w-1/2">
                    <h1 class="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
                        Hello, <%= session.getAttribute("username") %></h1>
                    <p class="text-xl lg:text-2xl mt-6 font-light"> manage your details efficiently with just one click!
                       
                    </p>
                    <p class="mt-8 md:mt-12">
                        <form action="ViewTransactionsController" method="post">
    <button type="submit" class="px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300">
        View Passbook
    </button>
</form>
                    </p>
